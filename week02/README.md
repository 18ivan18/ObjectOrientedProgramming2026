...
която събира две комплексни числа. Създайте функция, която умножава две комплексни числа.
Създайте функция, която намира комплексно спрегнатото на комплексно число.
...
**Бонус:** Създайте функция, която конструира `Quadratic` структура от уравнение, зададено като символен низ, например `2*x^2 + 12*x + 32 = 0`. Поддържайте форматa `a*x^2 + b*x + c = 0`, където коефициентите могат да са положителни или отрицателни, а `*` преди `x` е опционален.