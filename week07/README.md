...
### Примери за постановки (сериализация, текст и двоичен файл)

В [`examples/file_io_patterns/README.md`](examples/file_io_patterns/README.md) има отделни програми за: текстов файл със статичен и динамичен масив от обекти; един обект в двоичен файл; статичен и динамичен масив в двоичен файл. Споделена структура: [`examples/file_io_patterns/Record.h`](examples/file_io_patterns/Record.h).
